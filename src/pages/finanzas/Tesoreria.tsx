                      ...
                      <tr key={movimiento.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            movimiento.estado_conciliacion === 'CONCILIADO' ? 'bg-green-100 text-green-800 border border-green-200' :
                            movimiento.estado_conciliacion === 'CONTABILIZADO' ? 'bg-blue-100 text-blue-800 border border-blue-200' :
                            movimiento.estado_conciliacion === 'RECHAZADO' ? 'bg-red-100 text-red-800 border border-red-200' :
                            'bg-yellow-100 text-yellow-800 border border-yellow-200'
                          }`}>
                            {movimiento.estado_conciliacion || 'PENDIENTE'}
                          </span>
                        </td>
