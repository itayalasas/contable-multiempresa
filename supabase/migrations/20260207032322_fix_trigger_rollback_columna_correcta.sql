/*
  # Corregir trigger - Usar nombre correcto de columna
  
  ## Problema
  El trigger usa `actualizado_en` pero la columna correcta es `updated_at`.
  
  ## Solución
  Actualizar la función del trigger para usar `updated_at`.
*/
...
'Trigger que hace rollback completo al eliminar factura por pagar: comisiones, asientos y pagos. Usa updated_at en lugar de actualizado_en.';
